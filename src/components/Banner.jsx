...
function Banner({
    ...
    return (
        <div className="border-1 border-white/20 shadow-black/60 shadow-[0_10px_30px_1px_rgba(59,130,246,0.5)] h-60 w-[1100px] rounded-2xl flex" key={itemNumber}>
            {/* image things */}
            <div className=" h-60 rounded-l-2xl overflow-hidden [mask-image:linear-gradient(to_left,transparent,black_20%)]">
                <img src={img} crossOrigin="anonymous" alt="img" className="h-60"/>
            </div>
            {/* headlines */}
            ...
            <button className="bg-orange-600 h-fit p-3 pl-3 pr-3 rounded-2xl w-28 ">shop Now</button>
            </div>
        </div>
    )
}
